        ...
        try
        {
            do
            {
                ...
                if (pin == 1234) // cek pin
                    do
                    {
                        str = JOptionPane.showInputDialog(null,"[1] INOFRMASI SALDO \n"
                                + "[2]PENYETORAN \n [3] PENARIKAN \n [4] PETUNJUK \n"
                        ...
                        switch (choice)
                        {
                            ...
                            break;
                                    ...
                                    JOptionPane.showMessageDialog(null, "Terimakasih telah menggunaan ATM BNI SYARIAH-BOJONEGORO, ambil kartu ATM Anda.");
                                System.exit(0);
